    ...
    onSubmit: async ({ value, formApi }) => {
      try {
        await residentsApi.create({
          ...
          idNumber: value.id_number ?? undefined,
          gender: value.gender,
          dateOfBirth: value.date_of_birth?.toISOString() ?? undefined,
          maritalStatus: value.marial_status || undefined,
          occupation: value.occupation || undefined,
          email: value.email || undefined,
          kk: value.kk || undefined,
          blok: value.blok || undefined,
          rt: value.rt || undefined,
          houseNumber: value.house_number || undefined,
          houseType: value.house_type || undefined,
          ownershipStatus: value.ownership_status || undefined,
          startDateOfOccupancy: value.start_date_of_occupancy?.toISOString() ?? undefined,
        })
