...
export declare class KeamananService {
    private prisma;
    ...
    createPetugas(dto: CreatePetugasDto, userId: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        fullName: string;
    ...
    createTamu(dto: CreateBukuTamuDto, userId: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        notes: string | null;
    ...
    findAllInsiden(query: QueryLaporanInsidenDto, currentUser: {
        id: string;
        role: string;
    }): Promise<{
        data: ({
    ...
    createInsiden(dto: CreateLaporanInsidenDto, userId: string): Promise<{
        processor: {
            profile: {
                fullName: string | null;
            } | null;
    ...
    updateInsidenStatus(id: string, dto: UpdateInsidenStatusDto, adminId: string): Promise<{
        processor: {
            profile: {
                fullName: string | null;
            } | null;
    ...
    cancelInsiden(id: string, currentUser: {
        id: string;
        role: string;
    }): Promise<{
        description: string;
